...
DSFMT_PST_INLINE;
DSFMT_PRE_INLINE uint32_t dsfmt_genrand_uint32_range(dsfmt_t* dsfmt, const uint32_t Range)
DSFMT_PST_INLINE;
...
DSFMT_PRE_INLINE uint32_t dsfmt_gv_genrand_uint32_range(const uint32_t Range) DSFMT_PST_INLINE;
...
* @return double precision floating point pseudorandom number
*/
inline static uint32_t dsfmt_gv_genrand_uint32()
{
    return dsfmt_genrand_uint32(&dsfmt_global_data);
}

inline static uint32_t dsfmt_genrand_uint32_range(dsfmt_t* dsfmt, const uint32_t Range)
{
    return dsfmt_genrand_uint32(dsfmt) % Range;
}

inline static uint32_t dsfmt_gv_genrand_uint32_range(const uint32_t Range)
{
    return dsfmt_genrand_uint32(&dsfmt_global_data) % Range;
}
